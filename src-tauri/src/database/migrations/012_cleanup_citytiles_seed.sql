-- 012_cleanup_citytiles_seed.sql
-- Remove ALL City Tiles seed data and re-insert correct MoonPipe products
-- 004 seeded products with SKU/ID conflicts that caused 011's INSERT OR IGNORE to silently skip rows

-- 1. Delete everything — clean slate
DELETE FROM products;

-- 2. Re-insert all 20 MoonPipe products (sanitary 10 + hardware 10)
